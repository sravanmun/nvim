  ...
  ▐░▌         ▐░▌       ▐░▌     ▐░▌▐░▌ ▐░▌▐░▌
   ▐░▌       ▐░▌        ▐░▌     ▐░▌ ▐░▐░▌ ▐░▌
        ...
        ▐░▌        ▐░░░░░░░░░░░▌▐░▌       ▐░▌
         ▀          ▀▀▀▀▀▀▀▀▀▀▀  ▀         ▀ 
          ...
          keys = {
            ...
            { icon = " ", key = "c", desc = "Config",        action = (":lua require('snacks').picker.files({ cwd = '%s' }) "):format(vim.fn.stdpath("config")) },
    ...
    keys = {
      ...
      { "<leader>uc", function() require("snacks").picker.colorschemes() end,  desc = "Change color scheme" },
